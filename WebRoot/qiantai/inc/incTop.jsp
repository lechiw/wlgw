...
<html>
  <head>
      <style type="text/css">
        .Header {background: url(<%=path %>/img/banner.jpg) #d10e00 repeat-x left top; height: 100px;width: 966px;}
  ...
  <body>
        <div class="Header HeaderTop">
			<br/><br/>
			<font style="font-size: 40px;color: white;font-weight: bolder;display: block;text-align: center;">尚学馆</font>
		</div>
		<div class="topmenu cbody1">
			<ul>
				<li class="thisclass">
					<A href="<%=path %>/qiantai/default.jsp">商品信息</A>
				</li>
				<li class="thisclass">
					<A href="<%=path %>/goodsAllYesTejia.action">特价区域</A>
				</li>
				<li class="thisclass">

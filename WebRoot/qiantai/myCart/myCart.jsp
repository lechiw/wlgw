			...
			<div class="left_row">
				<div class="list pic_news">
					...
					<table width="99%" border="0" cellpadding="2" cellspacing="1"
						...
						<s:iterator value="#items">
							<tr align='center' bgcolor="#FFFFFF" height="22">
								<td><s:property value="value.goods.goodsName" />
								</td>
								<td>￥<s:property value="value.goods.goodsTejia" /><br />
								</td>
								...
								<td>￥<s:property
										value="value.goodsQuantity * value.goods.goodsTejia" />
								</td>
								<td><input
									onClick="delGoodsFromCart(<s:property value="value.goods.goodsId"/>)"
									type="image" src="<%=path%>/img/delete_01.gif" border="0" />
								</td>
							</tr>
						</s:iterator>
						<tr>
							<td colspan="6" class="Order_Total"><img hspace="5"
								src="<%=path%>/img/me03.gif" /> 总金额：￥<span id="totalMoney"><s:property
										value="#session.cart.totalPrice" />
							</span> &nbsp;&nbsp;&nbsp;&nbsp; <img id="indicator1"
					...
					<table>
						...
						<tr>
							<td width="120"></td>
							<td><a href="#" onclick="clearCart()"><img border="0"
									src="<%=path%>/img/Car_icon_01.gif" />
							</a>
							</td>
							<td><a href="<%=path%>/qiantai/default.jsp"><img
									border="0" src="<%=path%>/img/Car_icon_02.gif" />
							</a>
							</td>
							<td><a href="<%=path%>/orderQueren.action"><img
									border="0" src="<%=path%>/img/Car_icon_03.gif" />
							</a>
							</td>
						</tr>
					</table>

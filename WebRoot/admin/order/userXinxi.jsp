...
<body>
	<table width="98%" border="0" align="center" cellpadding="0"
		...
		<tr>
			<td width="30%" height="30" align="right" bgcolor="#F9F9F9"
				style="font-size: 11px;">用户名：</td>
			<td width="70%" bgcolor="#FFFFFF">&nbsp; <input type="text"
		...
		<tr>
			...
			<td bgcolor="#FFFFFF">&nbsp; <input type="password"
				name="userPw" value="${requestScope.user.userPw }" /></td>
		</tr>
		<tr>
			<td height="30" align="right" bgcolor="#F9F9F9"
				style="font-size: 11px;">姓名：</td>
			<td bgcolor="#FFFFFF">&nbsp; <input type="text"
				name="userRealname" value="${requestScope.user.userRealname }" /></td>
		</tr>
		<tr>
			<td height="30" align="right" bgcolor="#F9F9F9"
				style="font-size: 11px;">住址：</td>
			<td bgcolor="#FFFFFF">&nbsp; <input type="text"
				name="userAddress" value="${requestScope.user.userAddress }" /></td>
		</tr>
		<tr>
			<td height="30" align="right" bgcolor="#F9F9F9"
		...
		<tr>
			...
			<td bgcolor="#FFFFFF">&nbsp; <input type="text" name="userTel"
				value="${requestScope.user.userTel }" /></td>
		</tr>
	</table>
</body>
</html>
